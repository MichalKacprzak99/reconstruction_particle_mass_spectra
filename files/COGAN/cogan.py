...
from settings import sample_images, prepare_data
...
class COGAN():
    ...
    def build_generators(self):
        ...
        g1 = Dense(np.prod(self.vec_shape), activation='tanh')(g1)
        img1 = Reshape(self.vec_shape)(g1)

        # Generator 2
        g2 = Dense(1024)(feature_repr)
        g2 = LeakyReLU(alpha=0.2)(g2)
        g2 = BatchNormalization(momentum=0.8)(g2)
        g2 = Dense(np.prod(self.vec_shape), activation='tanh')(g2)
        img2 = Reshape(self.vec_shape)(g2)
        print("gen")
        model.summary()
    ...
    def build_discriminators(self):
        ...
        img1 = Input(shape=self.vec_shape)
        img2 = Input(shape=self.vec_shape)
